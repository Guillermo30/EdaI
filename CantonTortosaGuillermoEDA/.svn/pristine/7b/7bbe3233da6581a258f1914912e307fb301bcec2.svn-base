...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * @param i Indice/posición en el array
	 * @return Elemento de esa indice o posición.
	 */
	...
	/**
	 * Sustituye o asigna en la posición de array indicada un elemento.
	 * @param i Posición a sustituir o asignar.
	 * @param integer Elemento que se ingresará en la posición.
	 */
	...
	/**
	 * Método toString que muestra por pantalla el contenido del heap.
	 */
	...
	/**
	 * Método que incrementa el valor existente en una posición del array/heap.
	 * @param i Posición a incrementar el valor.
	...
	/**
	 * Flota si hiciera falta una posición dentro del heap.
	 * @param start Posición a flotar.
	 */
	...
	/**
	 * Decrementa el valor de una posición del heap.
	 * @param i Posición a decrementar.
	...
	/**
	 * Método que remplaza el valor de una posición en el heap.
	 * @param i Posición a remplazar su valor.
	...
	/**
	 * Método que elimina una posición de heap.
	 * @param i Posición a eliminar.
	 * @return True en caso que se haya podido eliminar.
	 */
	public boolean delete(int i) {//realizando primero decreaseKey(i, A) y después removeMin().
		try{
			Integer tmp = (Integer) getValue(i);
			decreaseKey(i, tmp); 	//Decrementa el mismo valor que tiene por tanto será 0 y 
			removeMin();			//después eliminaremos el primero que será 0.
			return true;
		}
		catch(Exception e){
			System.out.println(e.getMessage());
	...
	/**
	 * Método que suma los elementos de cada rama y devuelve la rama con menor valor en sus 
	 * elementos desde la hoja hasta la raíz.
	 * @return Rama con el valor mínimo de elementos
	 */
