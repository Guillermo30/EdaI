...
public Iterator<T> iterator()
   ...
   public String toString()
   {
	...
	////////////////EJERCICIO EXTRA (ESTÁ EN EL TEST PERO NO EN LA ACTIVIDAD)///////////////////////
	public String toStringPreorder(){ //Usamos el método recursivo ya creado...preorderDisplay()
		return toStringPreoder(this.root);
	}
	private static <T> String toStringPreoder(BSTNode<T> t){
		return preorderDisplay(t);
	}
	public String toStringIterativePreorder(){ //Método iterativo.
